...
abstract class TMAbstractXml implements TMXmlInterface
{
    ...
    public function setDOMDocument($doc)
    {
        ...
        {
            throw new TMXmlException(TMExceptionConstants::xmlError(TMExceptionConstants::XML_ERROR_SET_DOM));
        }
        $this->doc = $doc;
    }
    ...
    public function getXML($node = null)
    {
        ...
        {
            throw new TMXmlException(TMExceptionConstants::xmlError(TMExceptionConstants::XML_ERROR_SET_NODE));
        }
